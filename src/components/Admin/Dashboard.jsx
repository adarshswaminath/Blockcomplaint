    ...
    return (
      <div className='p-3'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#1e246a] shadow-lg p-6 rounded-lg text-center justify-center items-center">
            <div className="mb-4">
              <input type="text" className="bg-white p-3 rounded-lg text-center border-none" placeholder="ID" onChange={handleSubmitId} />
            </div>
            <div className="mb-4">
              <textarea name="" id="" cols="30" rows="10"
                onChange={handleSubmitResponse} className="bg-white text-center rounded-lg" placeholder='Response'
              ></textarea>
            </div>
          ...
          {data && (
            <div className="p-6 rounded-lg shadow-md bg-[#1e246a]">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <p className="mb-2 font-semibold text-[#fe1f84] text-sm uppercase">Complaint ID</p>
                  <p className="text-2xl font-bold text-blue-500">{ethers.BigNumber.from(data[0]._hex).toString()}</p>
                </div>
                <div className="text-center">
                  <p className="mb-2 font-semibold text-white text-sm uppercase">Complaint Status</p>
                  <p className={`text-2xl font-bold ${data[10] ? "text-green-500" : "text-red-600"}`}>
                    {data[10] ? "Resolved" : "Pending"}
                  </p>
                </div>
                <div>
                  <p className="mb-2 font-semibold text-white text-sm uppercase">Complaint</p>
                  <p className="text-lg">{data[6]}</p>
                </div>
                <div>
                  <p className="mb-2 font-semibold text-white text-sm uppercase">Response</p>
                  <p className="text-lg">{data[8] ? data[8] : "No response yet"}</p>
                </div>
                <div>
                  <p className="mb-2 font-semibold text-white text-sm uppercase">Complainant Information</p>
                ...
                <div>
                  <p className="mb-2 font-semibold text-white text-sm uppercase">Complaint Details</p>
                ...
                <div>
                  <p className="mb-2 font-semibold text-white text-sm uppercase">Wallet</p>
  ...
  return (
    <div className="min-h-screen">
      <div className="heading p-4">
        <h1 className="title text-xl lg:text-3xl text-white">Hi admin,</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 text-white p-4">
        ...
        <div className="flex gap-3">
          {/* card 1 */}
          <div className="card flex-1 p-8 rounded-lg bg-gradient-to-tl from-[#b588f6] to-[#906ad8] text-center">
            <span className="text-4xl mb-2 font-bold">
              {ethers.BigNumber.from(count).toString()}
            </span>
            <button onClick={() => handleCount(contract)} className="font-semibold">
              Total Complaints
            </button>
          </div>
          {/* card 2 */}
          <div className="card flex-1 text-center p-8 rounded-lg bg-gradient-to-tl from-[#bc57af] to-[#f480df]">
            <span className="text-4xl mb-2 font-bold">
        ...
        <div className="flex gap-3">
          {/* card 3 */}
          <div className="card flex-1 text-center p-8 rounded-lg bg-gradient-to-tl from-fuchsia-500 to-cyan-500">
            <button
          ...
          <div className="card flex-1 text-center p-8  bg-gradient-to-tl from-cyan-400 to-indigo-500">
